...
1. حمّل الملف المضغوط من [هنا (Release v1.0.0)](https://github.com/S-mohannad/license-plate-detector-iraq/releases/tag/v1.0.0)
2. فك الضغط في أي مكان على جهازك
3. شغّل `CarPlateDetector.exe`
4. يعمل على ابعاد شاشه (1920*1080) يعني FULL HD
